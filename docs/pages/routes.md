...
We left off in Getting Started with one route already set up to the root directory (`'/'`). 
...
1.  Create a new JavaScript File called `contactRoute.js`.
    You can technically make this file anywhere you wish in your project but we suggest follow this [project structure](/pages/possible-project-structure).
